...
} from "./node_modules/@pepperi-addons/papi-sdk/dist/entities/data-view";
import generalService, { NavigationOptions } from "./services/general.service";
import DataService, {
  OCEvents,
  GENERIC_DATA_VIEWS,
  accounDataArr,
    ...
    it("UIObject.Create - DataView.Fields parsed test results", async () => {
      if (fields) {
        ...
        expect(fields[0].Style, "Failed on Email style returning wrong value")
          ...
          expect(fields[1].FieldID, "Failed on wrong FieldID returning for ExternalID")
            .to.be.a("string")
            .and.is.equal("ExternalID");
          expect(fields[1].Layout, "Failed on wrong layout returning for ExternalID")
            .to.be.an("object")
            .and.is.deep.equal({
              Origin: { X: 0, Y: 1 },
              Size: { Width: 1, Height: 1 },
          ...
          expect(fields[1].Title, "Failed on ExternalID Title returning wrong value")
            .to.be.a("string")
            .that.is.equal("ExternalID");
          expect(fields[1].Type, "Failed on ExternalID Type returning wrong value")
            .to.be.a("string")
            .that.is.equal("TextBox");
          expect(fields[1].Style, "Failed on ExternalID style returning wrong value")
            .to.be.an("object")
            .that.is.deep.equal({
              Alignment: { Vertical: "Center", Horizontal: "Left" },
            });
          ...
          expect(fields[2].FieldID, "Failed on wrong FieldID returning for Mobile")
            .to.be.a("string")
            .and.is.equal("Mobile");
          ...
          expect(fields[3].FieldID, "Failed on wrong FieldID returning for Status")
            .to.be.a("string")
            .and.is.equal("Status");
          ...
          expect(fields[3].Style, "Failed on Status style returning wrong value")
            ...
            expect(fields[4].Style, "Failed on UUID style returning wrong value")
              ...
              expect(fields[5].FieldID, "Failed on wrong FieldID returning for WrntyID")
                .to.be.a("string")
              ...
              expect(fields[6].FieldID, "Failed on wrong FieldID returning for TSADateTime")
                .to.be.a("string")
                .and.is.equal("TSADateTimeCnct");
              expect(fields[6].Layout, "Failed on wrong layout returning for TSADateTime")
                .to.be.an("object")
                .and.is.deep.equal({
                  Origin: { X: 0, Y: 6 },
                  Size: { Width: 1, Height: 1 },
              ...
              expect(fields[6].Title, "Failed on TSADateTime Title returning wrong value")
                .to.be.a("string")
                .that.is.equal("DateTimeCnct");
              expect(fields[6].Type, "Failed on TSADateTime Type returning wrong value")
                .to.be.a("string")
                .that.is.equal("DateAndTime");
              expect(fields[6].Style, "Failed on TSADateTime style returning wrong value")
                .to.be.an("object")
                .that.is.deep.equal({
                  Alignment: { Vertical: "Center", Horizontal: "Left" },
                });
                ...
                expect(fields[7].FieldID, "Failed on wrong FieldID returning for TSADecimal")
                  .to.be.a("string")
                  .and.is.equal("TSADecimalCnct");
                expect(fields[7].Layout, "Failed on wrong layout returning for TSADecimal")
                  .to.be.an("object")
                  .and.is.deep.equal({
                    Origin: { X: 0, Y: 7 },
                    Size: { Width: 1, Height: 1 },
                ...
                expect(fields[7].Title, "Failed on TSADecimal Title returning wrong value")
                  .to.be.a("string")
                  .that.is.equal("DecimalCnct");
                expect(fields[7].Type, "Failed on TSADecimal Type returning wrong value")
                  .to.be.a("string")
                  .that.is.equal("NumberReal");
                expect(fields[7].Style, "Failed on TSADecimal style returning wrong value")
                  .to.be.an("object")
                  .that.is.deep.equal({
                    Alignment: { Vertical: "Center", Horizontal: "Left" },
                  });
                  ...
                  expect(fields[8].FieldID, "Failed on wrong FieldID returning for TSASingleLineTextCnct")
                    .to.be.a("string")
                    .and.is.equal("TSASingleLineTextCnct");
                  expect(fields[8].Layout, "Failed on wrong layout returning for TSASingleLineTextCnct")
                    .to.be.an("object")
                    .and.is.deep.equal({
                      Origin: { X: 0, Y: 8 },
                      Size: { Width: 1, Height: 1 },
                  ...
                  expect(fields[8].Title, "Failed on TSASingleLineTextCnct Title returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("SingleLineTextCnct");
                  expect(fields[8].Type, "Failed on TSASingleLineTextCnct Type returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("TextBox");
                  expect(fields[8].Style, "Failed on TSASingleLineTextCnct style returning wrong value")
                    .to.be.an("object")
                    .that.is.deep.equal({
                      Alignment: { Vertical: "Center", Horizontal: "Left" },
                    });
                  ...
                  expect(fields[9].FieldID, "Failed on wrong FieldID returning for TSALimitedLineTextCnct")
                    .to.be.a("string")
                    .and.is.equal("TSALimitedLineTextCnct");
                  expect(fields[9].Layout, "Failed on wrong layout returning for TSALimitedLineTextCnct")
                    .to.be.an("object")
                    .and.is.deep.equal({
                      Origin: { X: 0, Y: 9 },
                      Size: { Width: 1, Height: 1 },
                  ...
                  expect(fields[9].Title, "Failed on TSALimitedLineTextCnct Title returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("LimitedLineTextCnct");
                  expect(fields[9].Type, "Failed on TSALimitedLineTextCnct Type returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("LimitedLengthTextBox");
                  expect(fields[9].Style, "Failed on TSALimitedLineTextCnct style returning wrong value")
                    .to.be.an("object")
                    .that.is.deep.equal({
                      Alignment: { Vertical: "Center", Horizontal: "Left" },
                    });
                  ...
                  expect(fields[10].FieldID, "Failed on wrong FieldID returning for TSAParagraphTextCnct")
                    .to.be.a("string")
                    .and.is.equal("TSAParagraphTextCnct");
                  expect(fields[10].Layout, "Failed on wrong layout returning for TSAParagraphTextCnct")
                    .to.be.an("object")
                    .and.is.deep.equal({
                      Origin: { X: 0, Y: 10 },
                  ...
                  expect(fields[10].Title, "Failed on TSAParagraphTextCnct Title returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("ParagraphTextCnct");
                  expect(fields[10].Type, "Failed on TSAParagraphTextCnct Type returning wrong value")
                    .to.be.a("string")
                    .that.is.equal("TextArea");
                  expect(fields[10].Style, "Failed on TSAParagraphTextCnct style returning wrong value")
                    .to.be.an("object")
                    .that.is.deep.equal({
                      Alignment: { Vertical: "Center", Horizontal: "Left" },
                    });
